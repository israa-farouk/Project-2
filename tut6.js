...
btn2.on("click", () => {
    ...
    serverConnection = new WebSocket(destination);
    serverConnection.onmessage = handleMessage;
    document.getElementById('mapdiv').style.top="25%";
    document.getElementById('instructions3').style.top="28%";
    document.getElementById('instructions3').innerHTML='Caregiver, Please connect the device audio to an external (bluetooth speaker) & move the speaker & selected toy to the selected room ';
    document.getElementById('heading2').innerHTML=' Let Oma & Opa know how Rhys is responding to the sounds';
